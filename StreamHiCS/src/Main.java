...
public class Main {
	...
	public static void main(String[] args) {
		 ...
		 * RandomRBFGenerator(); stream.prepareForUse(); int numberOfDimensions
		 * = stream.numAttsOption.getValue(); //
		 * 
		 * 
		 ...
		 * 
		 * StreamHiCS streamHiCS = new StreamHiCS(numberOfDimensions,
		 * numberOfDimensions, numberOfDimensions, numberOfDimensions,
